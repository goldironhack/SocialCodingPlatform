...
var CuteLogger = function () {
    function CuteLogger() {
        _classCallCheck(this, CuteLogger);
    }

    _createClass(CuteLogger, null, [{
        key: "log",
        ...
        value: function log(message, type) {
            ...
            var str = CuteLogger.config.streams[type.stream] || CuteLogger.config.streams.out;
